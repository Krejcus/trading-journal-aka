  ...
  return <>
    ...
    {open && createPortal(
      <div
        ...
        // Paleta musí ležet nad každým dialogem, ze kterého se otevírá — nastavení
        // grafu má vlastní vrstvu vysoko nad ostatními a schovávalo ji pod sebe.
        className="fixed z-[10100] w-[256px] rounded-md border border-slate-300 bg-white p-2 shadow-2xl"
