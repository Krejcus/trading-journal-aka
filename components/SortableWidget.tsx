...
const SortableWidget: React.FC<SortableWidgetProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`${gridClass} ${rowSpanClass} relative h-full overflow-visible ${isEditing ? 'cursor-grab active:cursor-grabbing hover:z-[50]' : ''} data-[dragging]:border-2 data-[dragging]:border-dashed data-[dragging]:border-indigo-500/80 data-[dragging]:bg-indigo-500/10 data-[dragging]:rounded-[32px] data-[dragging]:[&>div]:opacity-0`}
      >
        {isEditing && (
          <div className="absolute inset-0 z-30 pointer-events-none rounded-[32px] ring-2 ring-indigo-500/0 hover:ring-indigo-500/50 transition-all duration-300 group data-[dragging]:hidden">
            {/* Label Tag */}
            <div
