  ...
  useEffect(() => {
    ...
    const chart = createChart(containerRef.current, {
      ...
      timeScale: {
        ...
        tickMarkFormatter: (time: Time) => new Date(Number(time) * 1000).toLocaleTimeString('cs-CZ', { timeZone: 'Europe/Prague', hour: '2-digit', minute: '2-digit' }),
      },
      localization: {
        locale: 'cs-CZ',
        timeFormatter: (time: Time) => new Date(Number(time) * 1000).toLocaleString('cs-CZ', { timeZone: 'Europe/Prague', day: '2-digit', month: '2-digit', hour: '2-digit', minute: '2-digit' }),
