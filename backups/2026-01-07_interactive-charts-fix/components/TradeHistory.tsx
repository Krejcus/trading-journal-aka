        ...
        {trades.slice().reverse().map((trade) => {
          ...
          return (
            <div
              ...
              className={`group relative flex flex-col md:flex-row h-auto md:h-56 rounded-[24px] border overflow-hidden transition-all duration-500 cursor-pointer ${glowClass} ${theme !== 'light'
                ? 'bg-[var(--bg-card)]/80 border-[var(--border-subtle)] backdrop-blur-md hover:bg-[var(--bg-card)]'
