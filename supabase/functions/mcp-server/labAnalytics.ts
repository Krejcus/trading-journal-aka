 ...
 */
// Runtime-erased application DTOs; algorithm stays in parity with the app.
type Trade = Record<string, any>;
type Account = Record<string, any>;
import { selectExperimentCohorts, type ExperimentCohortConfig } from './experimentCohorts.ts';
